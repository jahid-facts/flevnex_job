                                ...
                                <td style="padding: 40px 0px 0px;">
                                    <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                                        <div style="color: rgb(0, 0, 0); text-align: center;">
                                            <img width="200px"
                                                src="https://songsofsyx.com/wiki/images/9/9e/Lock_icon.png"
                                                alt="">
                                            <h1 style="margin: 1rem 0; color: #1f1f1f;">Reset your password</h1>
                                            <p style="padding-bottom: 16px; color: #1f1f1f !important;">You requested to
                                                reset your password. Please click the button below to proceed.</p>
                                            <hr>
                                            <p style="padding-bottom: 26px; padding-top:10px; text-align: center;">
                                                <a href="{{ $mailData['link'] }}" target="_blank"
                                                    style="color: #ffffff;" class="button">Reset Password</a>
                                            </p>
