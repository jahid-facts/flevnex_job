      ...
      <div className="container">
        <div className="row grid">
          {data?.data?.map((item) => (
            <div
              key={item.id}
              className="col-lg-3 col-md-4 col-sm-6 grid-item sahitto"
            >
              ...
              <div className="portfolio-item-wrapper wow " data-wow-delay=".4s">
                ...
                <div className="portfolio-overlay">
                  <div className="overlay-content">
                    <h4>সংগীত কর্ম</h4>
                    <p>বাংলাদেশ কপিরাইট অফিস </p>
                    <Link className="theme-btn border-btn" to="details">
                      বিস্তারিত দেখুন
                    </Link>
                  </div>
                </div>
              </div>
              <Link className="m-auto buttonn my-3" to="details">
                {" "}
                <h5 className>সংগীত কর্ম</h5>
              </Link>
            </div>
          </div>
          <div className="col-lg-3 col-md-4 col-sm-6 grid-item silpo">
            <div className="card lormolist shadow-sm mb-4">
              <div className="portfolio-item-wrapper wow " data-wow-delay=".5s">
                <div className="portfolio-img">
                  <img src="assets/images/kormo/silpo.jpg" />
                </div>
                <div className="portfolio-overlay">
                  <div className="overlay-content">
                    <h4>শিল্প কর্ম</h4>
          ...
          <div className="col-lg-3 col-md-4 col-sm-6 grid-item cholochitro">
            <div className="card lormolist shadow-sm mb-4">
              ...
              <Link className="m-auto buttonn my-3" to="details">
                {" "}
                <h5 className>চলচ্চিত্র কর্ম</h5>
              </Link>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-md-4 col-sm-6 grid-item software">
            <div className="card lormolist shadow-sm mb-4">
              ...
              <Link className="m-auto buttonn my-3" to="details">
                {" "}
                <h5 className>সফ্‌ট-ওয়্যার কর্ম</h5>
              </Link>
            </div>
          </div>
          <div className="col-lg-3 col-md-4 col-sm-6 grid-item telivision">
            <div className="card lormolist shadow-sm mb-4">
              ...
              <Link className="m-auto buttonn my-3" to="details">
                {" "}
                <h5 className>টেলিভিশন সম্প্রচার কর্ম</h5>
              </Link>
            </div>
          </div>
          <div className="col-lg-3 col-md-4 col-sm-6 grid-item betar">
            <div className="card lormolist shadow-sm mb-4">
              ...
              <Link className="m-auto buttonn my-3" to="details">
                {" "}
                <h5 className>বেতার সম্প্রচার কর্ম</h5>
              </Link>
            </div>
          </div>
          <div className="col-lg-3 col-md-4 col-sm-6 grid-item website">
            <div className="card lormolist shadow-sm mb-4">
              ...
              <Link className="m-auto buttonn my-3" to="details">
                {" "}
                <h5 className>ওয়েবসাইট, ই-মেইল কর্ম</h5>
              </Link>
            </div>
          </div>
          <div className="col-lg-3 col-md-4 col-sm-6 grid-item telivision">
