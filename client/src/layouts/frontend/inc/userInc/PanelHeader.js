              ...
              <div className="nav-inner">
                <nav className="navbar navbar-expand-lg">
                  <Link className="navbar-brand" to="/">
                    <img
                      className
                      src={`${publicUrl}/assets/images/logo3.png`}
                      alt="Logo"
                    />
                  </Link>
                    ...
                    <ul id="nav" className="navbar-nav ms-auto">
                      ...
                      <li className="nav-item">
                        <Link
                          ...
                          data-bs-target="#applicationTracking"
                          className="page-scroll"
                        >
                          আবেদন ট্রাকিং প্রক্রিয়া
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link
                          className="page-scroll"
                          to="/dashboard/user-profile/add"
                          onClick={handleNavLinkClick}
                        >
                          কপিরাইটের জন্য আবেদন করুন
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link
                          className="page-scroll"
                          to="/dashboard/user-profile/agreement-form-add"
                          onClick={handleNavLinkClick}
                        >
                          চুক্তিপত্রের জন্য আবেদন করুন
                        </Link>
                      </li>
                      <li className="nav-item rounded userLogoutBtn">
                        <Link to="/" className="btn white-bg mouse-dir">
                          প্রস্থান করুন
                        </Link>
                      </li>
                    </ul>
                  ...
                  <div className="button loginButtonBG">
                    ...
                    >
                      {isLoading ? <BeatLoader /> : "প্রস্থান করুন"}
      ...
      <section className="section p-0 service-single">
        <div className="container">
          <div
            ...
            aria-labelledby="applicationTrackingLabel"
            aria-hidden="true"
          >
              ...
              <div className="modal-content">
                <div className="modal-header user-modal-header">
                  <h5
                    ...
                    id="applicationTrackingLabel"
                  >
                    আবেদন পত্র ট্র্যাকিং প্রক্রিয়া
                  </h5>
                  <button
                    type="button"
                    className="btn-close "
                ...
                <div className="modal-footer user-modal-footer">
                  <button type="button" className="custombtn3">
                    সমর্পণ করুন
                  </button>
                </div>
              </div>
